...
if __name__ == '__main__':
    ...
    case = 0
    savetxt('sol/standard_sol/rho'+str(case), rho)
    savetxt('sol/standard_sol/u'+str(case),   u)
    savetxt('sol/standard_sol/v'+str(case),   v)
    savetxt('sol/standard_sol/E'+str(case),   E)
    set_trace()
